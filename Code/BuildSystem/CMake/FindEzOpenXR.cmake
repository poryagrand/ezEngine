...
if (CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
	...
	if(CMAKE_SIZEOF_VOID_P EQUAL 8)
		set(OPENXR_BIN_PREFIX "x64/openxr_loader_uwp")
	else()
		set(OPENXR_BIN_PREFIX "Win32/openxr_loader_uwp")
	endif()
...
if (EZOPENXR_FOUND)
	...
	if (OPENXR_DYNAMIC)
		set_target_properties(ezOpenXR::Loader PROPERTIES IMPORTED_LOCATION "${OPENXR_DIR_LOADER}/bin/Release/${OPENXR_BIN_PREFIX}/openxr_loader.dll")
		set_target_properties(ezOpenXR::Loader PROPERTIES IMPORTED_LOCATION_DEBUG "${OPENXR_DIR_LOADER}/bin/Debug/${OPENXR_BIN_PREFIX}/openxr_loader.dll")
	endif()
	set_target_properties(ezOpenXR::Loader PROPERTIES IMPORTED_IMPLIB "${OPENXR_DIR_LOADER}/bin/Release/${OPENXR_BIN_PREFIX}/openxr_loader.lib")
	set_target_properties(ezOpenXR::Loader PROPERTIES IMPORTED_IMPLIB_DEBUG "${OPENXR_DIR_LOADER}/bin/Debug/${OPENXR_BIN_PREFIX}/openxr_loader.lib")
